...
<div class = "bbplayer">
	...
	<div class = "field">
        <b>포지션</b>
        <select name = "pl_position" value = "<%=player.getPl_position() %>"required>
	...
	<div class = "field">
        <b>Subject</b>
        <textarea name="pl_subject" style="resize: none;" maxlength="100" cols = "60" rows="5" value = "<%=player.getPl_subject() %>"></textarea>
    </div>
	<div class = "field">
        <b>Content</b>
        <textarea name="pl_contents" style="resize: none;" maxlength="200" cols = "60"  rows="5" value = "<%=player.getPl_contents() %>"></textarea>
    </div>
    <div class = "field">
        <b>이미지</b>
